...
import evolution.fintech.tasklist.domain.exception.AccessDeniedException;
...
import evolution.fintech.tasklist.service.props.JwtProperties;
...
public class JwtTokenProvider {
    ...
    public JwtResponse refreshUserToken(String refreshToken) {
        ...
        if (!validateToken(refreshToken)) throw new AccessDeniedException();
        ...
        jwtResponse.setAccessToken(createRefreshToken(userId, user.getUsername()));
        return jwtResponse;
    }

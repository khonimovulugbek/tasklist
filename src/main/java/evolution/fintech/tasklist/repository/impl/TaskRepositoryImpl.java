...
public class TaskRepositoryImpl implements TaskRepository {
    ...
    public void update(Task task) {
        try {
            ...
            if (task.getDescription() == null) statement.setNull(2, Types.VARCHAR);
            else statement.setString(2, task.getDescription());

            if (task.getExpirationDate() == null) statement.setNull(3, Types.TIMESTAMP);
            else statement.setTimestamp(3, Timestamp.valueOf(task.getDescription()));
